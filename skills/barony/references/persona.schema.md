...
| `check_backlog` | read the project backlog (source per manifest: file or issue-tracker), EXCLUDING items marked with `manifest.backlog.park_label` when declared — a parked item is work a ratified decision superseded (ADR-009 §3.2) |
